...
from api.views import UserViewSet, PatientViewSet, AppointmentViewSet, InventoryViewSet, get_modules
from api.reports import user_registration_report, inventory_report
...
urlpatterns = [
    ...
    path("api/auth/", include("api.auth_routes")),
